  ...
  return (
    <div
      style={{
        ...
        background:
          "radial-gradient(circle at 72% 34%, rgba(99,102,241,0.2), transparent 34%), radial-gradient(circle at 26% 66%, rgba(34,211,238,0.16), transparent 36%), linear-gradient(150deg, #0d0f18 0%, #11131d 52%, #090b11 100%)",
        color: "#f8fafc",
      }}
    >
      <div
